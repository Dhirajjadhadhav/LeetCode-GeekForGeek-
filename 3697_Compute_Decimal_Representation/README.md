<h1>3697. Compute Decimal Representation</h1>

<div><div class="flex flex-col" style="position: relative;"><div class="elfjS" data-track-load="description_content"><p>You are given a <strong>positive</strong> integer <code>n</code>.</p>
